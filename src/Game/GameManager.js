 ...
 * @property {PlayersManager} _playersManager
 * @property {Array.<GoalInfo>} _goals
 * @property {string} _mode
 * @property {number} _limit
 * @property {number} _teamSize
 * @property {boolean} _started
 * @property {boolean} _finished
 * @property {number} _matchesPlayed
 * @property {Array.<BallTouchInfo>} _ballTouches
 * @property {{red: number, blue: number}} _victories
 */
 ...
 * @property {string|null} _assistBy
